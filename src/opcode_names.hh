/**
 *  Names for all opcodes.
 *  Source: https://github.com/drhelius/Gearboy/blob/master/src/opcode_names.h
 */
...
const std::array<std::string, 256> opcode_names = { "NOP",
                                                    "LD BC,nn",
                                                    "LD (BC),A",
                                                    "INC BC",
                                                    "INC B",
...
const std::array<std::string, 256> opcodes_cb_names = {
