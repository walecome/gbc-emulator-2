...
std::string strRed(std::string msg) { return "\033[1;31m" + msg + "\033[0m"; }

std::string strGreen(std::string msg) { return "\033[1;32m" + msg + "\033[0m"; }
...
void TestUtils::runTestNoArg(std::function<bool()> testFunc,
                             std::string testName) {
    TestUtils::total_tests++;
    // TestUtils::log("[" + testName + "] running test");
